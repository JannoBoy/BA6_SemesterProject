...
namespace ARPlacement
{
    public class ARObjectPlaceScript : MonoBehaviour
    {
            ...
            if (isPlacing)
            {
                ...
                if (Physics.Raycast(ray, out hit, maxRayDistance, collisionLayerMask))
                {
                    ...
                    if (SquareState == FocusState.Found)
                    {
                        ...
                        previewObject.transform.position = foundSquare.transform.position + new Vector3(0, previewObject.transform.localScale.y / 2, 0);
        ...
        public void EnablePlacing(bool selected)
        {
            isPlacing = selected;
        }
